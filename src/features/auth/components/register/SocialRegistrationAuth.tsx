...
export function SocialRegistrationAuth() {
      ...
      <div className="grid gap-3">
        <button
          ...
          onClick={() => {
            handleShowCloseToast({
              ...
              description: "Coming soon! Google Option is under development.",
            });
          }}
        >
          <svg
        ...
        <button
          ...
          onClick={() => {
            handleShowCloseToast({
              title: "Not Yet Available",
              description: "Coming soon! Apple Option is under development.",
            });
          }}
        >
          <svg
